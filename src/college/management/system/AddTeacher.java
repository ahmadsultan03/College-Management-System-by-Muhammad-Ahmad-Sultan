...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher() {
        ...
        JLabel heading = new JLabel("New Teacher (Faculty) Details");
        ...
        String course[] = { "PhD","MS","BS","B.Tech"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into teacher values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+cnic+"', '"+course+"', '"+branch+"')";
